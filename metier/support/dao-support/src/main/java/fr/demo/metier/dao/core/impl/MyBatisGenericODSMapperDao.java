...
public class MyBatisGenericODSMapperDao<PK extends Serializable, E extends GenericIdObject<PK>, M extends GenericMapper<PK, E>>
  extends SqlSessionDaoSupport implements Dao<E, PK> {

  private Class<M> basicMapper;

  public MyBatisGenericODSMapperDao(Class<M> basicMapper) {
